...
specifies the number of folds, which is 10 in this case. The cross_val_score
function returns the accuracies of all folds. The mean and standard deviation
of the accuracies are calculated and printed to the console.
"""
